#pragma checksum "C:\Proyecto bacon\bacon-desktop-malo\Views\Bar\IndexBar.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "fbcd5a86b272c713af6be25aa31356663686269e"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"fbcd5a86b272c713af6be25aa31356663686269e", @"/Views/Bar/IndexBar.cshtml")]
    public class Views_Bar_IndexBar : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 7851, true);
    ...
    <script type=""text/javascript"">
        ...
        ipcRenderer.on('asynchronous-reply-receta', (event, arg) => {
            ...
            for (var i = 0; i < arg.length; i++) {
                ...
                for (var j = 0; j < arg[i].recetaOrdenada.length; j++) {
                    ...
                    rec");
            WriteLiteral(@"etas += ""<tr><td class='pl-0'  >"" + cortarTextoConPuntos(arg[i].recetaOrdenada[j].receta.nombreReceta, 37) + ""</td>""
                ...
                message += ""<div class='card'><div class='card-body'><h4 class='card-title mt-3'>Orden número #"" + arg[i].orden.idOrden + ""</h4>""
                    ...
                    + ""<d");
            WriteLiteral(@"iv class='badge badge-info mr-1 mt-1'>"" + calcularMinutos(arg[i].orden.fechaCompleta) + "" minutos</div> ""
                    + ""<br />""
        ...
        ipcRenderer.on('asynchronous-reply-receta-cantidad', (event, arg) => {
            ...
            document.getElementById('target-ord");
            WriteLiteral(@"-bar-cantidad').innerHTML = message;
