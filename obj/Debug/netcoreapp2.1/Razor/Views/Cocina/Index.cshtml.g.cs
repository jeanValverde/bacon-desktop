#pragma checksum "C:\Users\jean\Desktop\PORTAFOLIO DE TITULO\bacon-desktop\Views\Cocina\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "12018c0f35b0f29b16f791e5ae9235417e599514"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"12018c0f35b0f29b16f791e5ae9235417e599514", @"/Views/Cocina/Index.cshtml")]
    public class Views_Cocina_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 8207, true);
    ...
    <script type=""text/javascript"" >
        ...
        ipcRenderer.on('asynchronous-reply-receta', (event, arg) => {
            ...
            for (var i = 0; i < arg.length; i++) {
                ...
                message += ""<div class='card'><div class='card-body'><h4 class='card-title mt-3'>Orden número #"" + arg[i].orden.idOrden + ""</h4>""
                    ...
                    + ""<div cla");
            WriteLiteral(@"ss='badge badge-info mr-1'>"" + arg[i].orden.fechaCompleta + ""</div> ""
                    ...
                    + ""<button type='button' onclick='completarOrden("" + arg[i].orden.idOrden  + "")' class='btn btn-outline-success btn-fw'>Orden Lista</button></");
            WriteLiteral(@"th>""
        ...
        //para cargar la cantidad de receta 
         ...
         ipcRenderer.on('asynchronous-reply-receta-cantidad', (event, arg) => {
            ...
            for (var i = 0; i < arg.length; i++) {
                 message += ""<tr><td class='pl-0'><a href='#23423423' onclick='modalReceta( "" + arg[i].receta.");
            WriteLiteral(@"idReceta + ""  )' >"" + cortarTextoConPuntos(arg[i].receta.nombreReceta, 34) + ""</a>""
