#pragma checksum "C:\Users\CRISTIAN\Desktop\proyecto_portafolio\bacon-desktop\Views\Finanzas\IndexCierreCaja.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ebc1e1b89f3704baa340505e637da04f714272ac"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ebc1e1b89f3704baa340505e637da04f714272ac", @"/Views/Finanzas/IndexCierreCaja.cshtml")]
    public class Views_Finanzas_IndexCierreCaja : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 12648, true);
    ...
    <script type=""text/javascript"">
        ...
        function realizarCierreCaja() {
            ...
            if (montoFinal !== """") {
                if (!isNaN(montoFinal) && Number(montoFinal% 1)===0) {
                    if (Number(montoF");
            WriteLiteral(@"inal) < 0) {
                    ...
                    alert('El monto final debe ser un número entero');
                }
            } else {
        ...
        ipcRenderer.on(""information-dialog-reply-cierre-caja"", (sender, index) => {
            ...
            if (index == 0) {
                ...
                var montoFinal = Math.trunc(Number(document.getElementById(""montoFinal"").value));
                var datos = [{
                    ""montoInicial"": montoInicial,
                    ""recaudacionHoy"": recaudacionHoy,
                    ""mo");
            WriteLiteral(@"ntoFinal"": montoFinal
                }]
        ...
        ");
            WriteLiteral(@"    ipcRenderer.send(""information-dialog-cambiarMontoFinal-cierre-caja"");
        }
