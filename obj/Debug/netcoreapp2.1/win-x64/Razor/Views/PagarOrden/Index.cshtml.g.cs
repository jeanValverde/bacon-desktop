#pragma checksum "C:\Users\jean\Desktop\PORTAFOLIO DE TITULO\bacon-desktop\Views\PagarOrden\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6996813b295db34a582ebd440475a31bff962199"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6996813b295db34a582ebd440475a31bff962199", @"/Views/PagarOrden/Index.cshtml")]
...
");
    ...
    <script type=""text/javascript"">
        ...
        ipcRenderer.on('asynchronous-reply-p");
            WriteLiteral(@"agarOrden-clienteDetalle', (event, arg) => {
         ...
         ipcRenderer.on(");
            WriteLiteral(@"'asynchronous-reply-pagarOrden-totalOrdenClienteDetalle', (event, arg) => {
        ...
        function habilitarCambiarValor() {
             ipcRenderer.send(""informat");
            WriteLiteral(@"ion-dialog-cambiarTotalPagar"");
        }
        ...
        function pagarCliente(idCliente) {
            ...
            if (isPagoPersonalizado) {
                ...
                var checkUno = docu");
            WriteLiteral(@"ment.getElementById('isOperacionCambiarValorUno');
        ...
        ipcRenderer.on('asynchronous-reply-pagarOrden-pagarClientePersonalizado', (event, arg) => {
          ...
          ");
            WriteLiteral(@"  var loader = document.getElementById('loader');
            loader.style.visibility = 'hidden';
        });
