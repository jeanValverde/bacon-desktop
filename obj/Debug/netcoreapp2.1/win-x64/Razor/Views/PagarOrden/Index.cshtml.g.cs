#pragma checksum "C:\Users\jean\Desktop\PORTAFOLIO DE TITULO\bacon-desktop\Views\PagarOrden\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "12daf83a25da5a75e8411bca7b6786685f617172"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"12daf83a25da5a75e8411bca7b6786685f617172", @"/Views/PagarOrden/Index.cshtml")]
...
");
    ...
    <script type=""text/javascript"">
        ...
        function getClientesMesa() {
            ...
            var loader = docume");
            WriteLiteral(@"nt.getElementById('loader');
        ...
        ipcRenderer.on('asynchronous-reply-pagarOrden-clienteDetalle', (event, arg) => {
            ...
            var loader = document.getElementById('loader');
            loa");
            WriteLiteral(@"der.style.visibility = 'hidden';
         ...
         ipcRenderer.on('asynchronous-reply-pa");
            WriteLiteral(@"garOrden-totalPagarClienteDetalle', (event, arg) => {
        ...
        function habilitarDeshabilitarInput(isActive) {
            ...
            habilitar(document.getElementById('");
            WriteLiteral(@"isOperacionCambiarValorDos'));
        ...
        function pagarCliente(idCliente) {
            ...
            WriteLiteral(@"(checkDos.checked) {
                ...
                //aler");
            WriteLiteral(@"t(checkDos.checked);
        ...
        ipcRenderer.on('asynchronous-reply-rece");
            WriteLiteral(@"ta-pagarOrden-cliente', (event, arg) => {
            ...
            for (var i = 0; i < arg.length; i++) {
                    ...
                    for (var j = 0; j < arg[i].recetaOrdenada.length ; j++) {
                       ...
                       recetas  += ""<tr><td class='pl-0'><a href='#23423423' onclick='modalRecetaPagoOrden( "" + arg[i].recetaOrdenada[j].receta.idReceta + ""  )' >"" + arg[i].recetaOrdenada[j].receta.nombreReceta + ""</a>""
                         +  ""</td><td class='pr-0 text-right'><div class='badge badge-pill badge-primary'>"" +");
            WriteLiteral(@"  arg[i].recetaOrdenada[j].cantidad + ""</div></td></tr>"";
                ...
                message += ""<div class='card' style='border: 1px solid #eee;' ><div class='card-body'><h4 class='card-title mt-3'>Orden número #"" + arg[i].orden.idOrden + ""</h4>""
                    ...
                    + ""</tbody></table>""
                    + ""<h4 class='card-title mt-3'>Descripción<");
            WriteLiteral(@"/h4>""
        ...
        ipcRenderer.on('asynchronous-reply-rece");
            WriteLiteral(@"ta-pagarOrden-buscarCliente', (event, arg) => {
            ...
            if (arg.length == 0) {
                document.getElementById('cargaClientesOrden').innerHTML = ""<div class='mail-list'><div class='alert alert-primary' style='width:");
            WriteLiteral(@" 100%;' >No se encontraron resultados</div></div>"";
            }
