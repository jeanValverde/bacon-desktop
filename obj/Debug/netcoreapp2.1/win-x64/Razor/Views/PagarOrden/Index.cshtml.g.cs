#pragma checksum "C:\Users\jean\Desktop\PORTAFOLIO DE TITULO\bacon-desktop\Views\PagarOrden\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0777b43d4fa2a89741ea2680b5babb8bf427c8bd"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0777b43d4fa2a89741ea2680b5babb8bf427c8bd", @"/Views/PagarOrden/Index.cshtml")]
    ...
    ");
            ...
            for (var i = 0; i < arg.length; i++) {
                    ...
                    for (var j = 0; j < arg[i].recetaOrdenada.length ; j++) {
                       ...
                       recetas  += ""<tr><td class='pl-0'><a href='#23423423' onclick='modalRecetaPagoOrden( "" + arg[i].recetaOrdenada[j].receta.idReceta + ""  )' >"" + arg[i].recetaOrdenada[j].receta.nombreReceta + ""</a>""
                         +  ""</td><td class='pr-0 tex");
            WriteLiteral(@"t-right'><div class='badge badge-pill badge-primary'>"" +  arg[i].recetaOrdenada[j].cantidad + ""</div></td></tr>"";
      ...
      ");
        ...
        ipcRenderer.on('asynchronous-reply-receta-pagarOrden-buscarCliente', (event, arg) => {
            ...
            if (arg.length == 0) {
                document.getElementById('cargaClientesOrden').innerHTML = ""<div class='m");
            WriteLiteral(@"ail-list'><div class='alert alert-primary' style='width: 100%;' >No se encontraron resultados</div></div>"";
            }
