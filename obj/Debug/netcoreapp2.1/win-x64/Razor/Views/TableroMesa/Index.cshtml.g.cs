#pragma checksum "C:\Users\jean\Desktop\PORTAFOLIO DE TITULO\bacon-desktop\Views\TableroMesa\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "dbaa2ac8268797c7e52162c7dc5595f09a34932a"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"dbaa2ac8268797c7e52162c7dc5595f09a34932a", @"/Views/TableroMesa/Index.cshtml")]
    public class Views_TableroMesa_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 6169, true);
    ...
    <script type=""text/javascript"">
        ...
        ipcRenderer.on('asynchronous-reply-MesaHabilitada', (event, arg) => {
            ...
            for (var i = 0; i < arg.length; i++) {
                ...
                mesasHab += ""<div class='card'><div class='card-body' style='text-align:center'><h3>Mesa N° "" + arg[i].numeroMesa +
                    ...
                    ""</div></div></");
            WriteLiteral(@"div><div class='input-group'><button onclick='modificarMesa("" + arg[i].idMesa + "",2)' type='button' class='btn btn-outline-primary btn-lg btn-block mt-2'> Deshabilitar Mesa </button><button onclick='modificarMesa("" + arg[i].idMesa + "",3)' type='button' class='btn btn-primary btn-lg btn-block mt-2'> Mesa En Espera </button></div></div></div></div>"";
            }
        ...
        ipcRenderer.on('asynchronous-reply-MesasDeshabilitadasss', (event, arg) => {
            ...
            document.getElementById('target-ord-mesaHabili");
            WriteLiteral(@"tada').innerHTML = """";
        ...
        ipcRenderer.on('asynchronous-reply-MesaEspera', (event, arg) => {
            ...
            for (var i = 0; i < arg.length; i++) {
                ...
                mesasHab += ""<div class='card'><div class='card-body' style='text-align:center'><h3>Mesa N° "" + arg[i].numeroMesa +
                    ""</h3 ></br><div class='row' style='padding:5px'><div class='col-6'><div class='forms-group'><h5 style='height:35px'> Cantidad de Asientos</h5><div class='badge badge-pill badge-primary'>"" + arg[i].cantidadAsientosMesa +
                    ""</div></div></div ><d");
            WriteLiteral(@"iv class='col-6'><div class='forms-group'><h5 style='height:35px'>  Estado Mesa</h5><div class='badge badge-pill badge-primary'>"" + arg[i].estadoMesa +
