#pragma checksum "C:\Users\jean\Desktop\PORTAFOLIO DE TITULO\bacon-desktop\Views\Garzon\IndexGarzon.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "35bc5d2f41f4aaa6d83f9fc499c0b0d9201a90d1"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"35bc5d2f41f4aaa6d83f9fc499c0b0d9201a90d1", @"/Views/Garzon/IndexGarzon.cshtml")]
    public class Views_Garzon_IndexGarzon : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 8700, true);
    ...
    <script type=""text/javascript"">
        ...
        ipcRenderer.on('asynchronous-reply-ordenes-garzon', (event, arg) => {
            ...
            for (var i = 0; i < arg.length; i++) {
                message += ""<div class='col-12 mb-4'  ><div class='card'><div class='");
            WriteLiteral(@"card-body'><h4 class='card-title mt-3'>Orden número #"" + arg[i].orden.idOrden + ""</h4>""
                ...
                if (arg[i].recetaOrdenada.length == 0) {
                    message += ""<tr><td class='p");
            WriteLiteral(@"l-0'  >N/A</td><td class='pl-0'  >N/A</td></tr>"";
                }
        ...
        ipcRenderer.on('asynchronous-reply-grupo-recetas-garzon', (event, arg) => {
            let message = """";
     ");
            WriteLiteral(@"       //aca se carga la lista de recetas
        ...
        function cargarTextosGarzon() {
            ...
            highlightedItems.");
            WriteLiteral(@"forEach(function (userItem) {
        ...
        function estadoOrdenStyleGarzon(fecha) {
            var minutos = calcularMinutosGa");
            WriteLiteral(@"rzon(fecha);
            var integer = parseInt(minutos, 10);
            var estado = ""info"";
            if (integer < 15) {
                estado = ""danger""
