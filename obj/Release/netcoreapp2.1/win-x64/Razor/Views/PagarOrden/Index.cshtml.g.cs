#pragma checksum "C:\Users\jean\Desktop\PORTAFOLIO DE TITULO\bacon-desktop\Views\PagarOrden\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "109f46d4862f6e94f09359c8f8b2e204325201df"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"109f46d4862f6e94f09359c8f8b2e204325201df", @"/Views/PagarOrden/Index.cshtml")]
    public class Views_PagarOrden_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(0, 8120, true);
    ...
    <div class=""email-wrapper wrapper"">
        <div class=""row align-items-stretch"">
                    ...
                    <div class=""sender-details"">
                        <div class=""details"">
                            ...
                            <p class=""sender-email"">
                                Número de Cliente:
                                <a href=""#"" id=""numeroClienteDetalle"" ><!----numero de cliente-");
            WriteLiteral(@"-></a>
         ...
         ");
            WriteLiteral(@"                                   <h3 class=""font-weight-normal mb-0 mr-2"" id=""totalPagarClienteDetalle""></h3>
                                        </div>
                                ...
                                <div class=""card icon-card-dark mt-4"">
                                    <div class=""card-body"">
                                        ...
                                        <div class=""d-flex align-items-center mt-3 flex-wra");
            WriteLiteral(@"p"">
...
");
    ...
    <script type=""text/javascript"">
        ...
        function getClientesMesa() {
            ...
            ipcRenderer.send(""async-pagarOrden-clientes"", 'busc");
            WriteLiteral(@"ar');
        ...
        ipcRenderer.on('asynchronous-reply-pagarOrden-clienteDetalle', (event, arg) => {
            ...
            var loader = document.getE");
            WriteLiteral(@"lementById('loader');
            loader.style.visibility = 'hidden';
        ...
        ");
            WriteLiteral(@" ipcRenderer.on('asynchronous-reply-pagarOrden-totalPagarClienteDetalle', (event, arg) => {
        ...
        function cargarCliente(idCliente) {
            ...
            //var form = document.getElementById('formCambiarValorP");
            WriteLiteral(@"ago');
        ...
        function habilitarDeshabilitarInput(isActive) {
         ...
         ");
            WriteLiteral(@"   habilitar(document.getElementById('isOperacionCambiarValorDos'));
        ...
        i");
            WriteLiteral(@"pcRenderer.on('asynchronous-reply-receta-pagarOrden-cliente', (event, arg) => {
            ...
            for (var i = 0; i < arg.length; i++) {
                    ...
                    for (var j = 0; j < arg[i].recetaOrdenada.length ; j++) {
                       ...
                       recetas  += ""<tr><td class='pl-0'><a href='#23423423' onclick='modalRecetaPagoOrden( "" + arg[i].recetaOrdenada[j].receta.idReceta + ""  )' >"" + arg[i].recetaOrdenada[j].receta.nombreReceta + ""</a>""
                         +  ""</td><td class='pr-0 text-right'><div clas");
            WriteLiteral(@"s='badge badge-pill badge-primary'>"" +  arg[i].recetaOrdenada[j].cantidad + ""</div></td></tr>"";
                ...
                message += ""<div class='card' style='border: 1px solid #eee;' ><div class='card-body'><h4 class='card-title mt-3'>Orden número #"" + arg[i].orden.idOrden + ""</h4>""
                    ...
                    + ""</tbody></table>""
                    + ""<h");
            WriteLiteral(@"4 class='card-title mt-3'>Descripción</h4>""
        ...
        i");
            WriteLiteral(@"pcRenderer.on('asynchronous-reply-receta-pagarOrden-buscarCliente', (event, arg) => {
            ...
            if (arg.length == 0) {
                document.getElementById('cargaClientesOrden').innerHTML = ""<div class='mail-list'><div cla");
            WriteLiteral(@"ss='alert alert-primary' style='width: 100%;' >No se encontraron resultados</div></div>"";
            }
